...
export const Tiptap = ({
    ...
    return <div className="bg-background relative rounded-lg border shadow-sm">
        {editor && (
            <>
...
const LinkComponent = ({
    ...
    return <Popover open={isLinkPopoverOpen} onOpenChange={setIsLinkPopoverOpen}>
